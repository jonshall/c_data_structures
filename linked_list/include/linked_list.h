 ...
 *
 * @param position the position in the list relevant to the head (1)
 ...
 *
 * @param size             the number of nodes the list is currently storing
 ...
 *
 * @param customfree       pointer to the free function to be used with that
 * list
 * @param compare_function pointer to the compare function to be used with the
 * list
 * @returns                pointer to allocated list on success or NULL on
 * failure
 */
...
/**
 * @brief      get data from node at head of list without popping
 *
 * @param list list to pop the node out of
...
/**
 * @brief      get data from node at tail of list without popping
 *
 * @param list list to pop the node out of
...
/**
 * @brief                remove specific node from list based on
...
/**
 * @brief                 perform a user defined action on data contained in
 *                        all of the nodes in list
 *
 ...
 * @param search_data pointer to address of the data to be searched for
 ...
 * @param search_data    pointer to address of the data to be searched for
 * @return               pointer to list of all found occurrecnces on success
 *                       NULL on failure
 */
