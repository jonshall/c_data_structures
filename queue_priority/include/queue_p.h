 ...
 * @param customfree pointer to free function to be used with that list
 * @returns          pointer to allocated queue_p on success, NULL on failure
 */
...
/**
 * @brief       get data from node at front of queue without popping
 *
